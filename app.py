...
with topic_cols[0]:
    topic0 = st.number_input("Topic 0:", min_value=0.0, max_value=1.0, value=0.00, step=0.01, format="%.2f")
with topic_cols[1]:
    topic1 = st.number_input("Topic 1:", min_value=0.0, max_value=1.0, value=0.00, step=0.01, format="%.2f")
with topic_cols[2]:
    topic2 = st.number_input("Topic 2:", min_value=0.0, max_value=1.0, value=0.00, step=0.01, format="%.2f")
with topic_cols[3]:
    topic3 = st.number_input("Topic 3:", min_value=0.0, max_value=1.0, value=0.00, step=0.01, format="%.2f")
with topic_cols[4]:
    topic4 = st.number_input("Topic 4:", min_value=0.0, max_value=1.0, value=0.00, step=0.01, format="%.2f")
